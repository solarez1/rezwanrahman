...
<form id="form1" runat="server" enctype="multipart/form-data">
    <div>
            ...
            <tr><td>&nbsp;</td><td>
                ...
                <asp:Button ID="sitedb" runat="server" Text="SiteDB-Config" Width="200px" CssClass="button" OnClick="sitedb_Click" />
                         
             
                <br />
             
             
                <asp:Button ID="assetman" runat="server" Text="Asset-Config" Width="200px" CssClass="button" OnClick="assetman_Click" />
                ...
                <br />
                <br />
                <asp:FileUpload ID="sourceupload" runat="server" Width="595px" Font-Size="Large" />
             
                <br />
                <br />
             
                <asp:Button ID="saveclick1" runat="server" Text="Save-Files" Width="600px" CssClass="button" OnClick="saveclick1_Click" />
                ...
                <br />
                <br />
                <asp:FileUpload ID="destinationupload" runat="server" Width="595px" font-size="Large"/>
             
                <br />
                <br />
             
                <asp:Button ID="saveclick2" runat="server" Text="Save-Files" Width="600px" CssClass="button" OnClick="saveclick2_Click" />
                ...
                <tr><td>
                    &nbsp;</td><td>
                    <asp:TextBox ID="ResultBox" TextMode="MultiLine" Width="1400" Height="390" Font-Size="Large" ForeColor="#4DC34B" BackColor="Black" runat="server" ReadOnly="true"></asp:TextBox>
